...
public class SubsystemParsingTestCase extends AbstractSubsystemTest {
    ...
    public SubsystemParsingTestCase() {
        super(Names.SUBSYSTEM_NAME, new SubsystemExtension());
    }

    private String subsystemXml() throws IOException {
      return IOUtils.toString(
          getClass().getClassLoader().getResourceAsStream("subsystem.xml"));
    }
    ...
    public void testParseSubsystem() throws Exception {
        ...
        String subsystemXml = subsystemXml();
        ...
        Assert.assertEquals(Names.SUBSYSTEM_NAME, element.getValue());
    }
    ...
    public void testInstallIntoController() throws Exception {
        ...
        Assert.assertTrue(model.get(SUBSYSTEM).hasDefined(Names.SUBSYSTEM_NAME));
    }
