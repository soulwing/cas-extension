...
import org.soulwing.cas.extension.authentication.AuthenticationReaderWriter;
import org.soulwing.cas.extension.authorization.AuthorizationReaderWriter;
...
class SubsystemReaderWriter extends AbstractResourceReaderWriter {
  ...
  public SubsystemReaderWriter() {
    super(Names.NAMESPACE, ModelDescriptionConstants.SUBSYSTEM,
        new AuthenticationReaderWriter(), new AuthorizationReaderWriter());
  }
