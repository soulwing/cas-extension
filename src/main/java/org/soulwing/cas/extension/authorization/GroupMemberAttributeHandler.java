...
/** 
 * A write attribute handler for the LDAP group member attribute attribute.
 *
 * @author Carl Harris
 */
public class GroupMemberAttributeHandler
    extends AbstractWriteAttributeHandler<Void> {

  static final GroupMemberAttributeHandler INSTANCE =
      new GroupMemberAttributeHandler();
  
  private GroupMemberAttributeHandler() {
    super(GroupSearchDefinition.GROUP_MEMBER_ATTRIBUTE);
  }
