...
/** 
 * A write attribute handler for the LDAP filter attribute.
 *
 * @author Carl Harris
 */
public class LdapFilterHandler
    extends AbstractWriteAttributeHandler<Void> {

  static final LdapFilterHandler INSTANCE =
      new LdapFilterHandler();
  
  private LdapFilterHandler() {
    super(LdapSearchDefinition.FILTER);
  }
