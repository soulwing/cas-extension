...
/** 
 * A write attribute handler for the properties file attribute.
 *
 * @author Carl Harris
 */
public class PropertiesPathHandler
    extends AbstractWriteAttributeHandler<Void> {

  static final PropertiesPathHandler INSTANCE =
      new PropertiesPathHandler();
  
  private PropertiesPathHandler() {
    super(PropertiesDefinition.PATH);
  }
