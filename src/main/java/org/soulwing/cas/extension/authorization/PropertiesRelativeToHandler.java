...
/** 
 * A write attribute handler for the properties relative-to attribute.
 *
 * @author Carl Harris
 */
public class PropertiesRelativeToHandler
    extends AbstractWriteAttributeHandler<Void> {

  static final PropertiesRelativeToHandler INSTANCE =
      new PropertiesRelativeToHandler();
  
  private PropertiesRelativeToHandler() {
    super(PropertiesDefinition.RELATIVE_TO);
  }
