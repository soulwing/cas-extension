...
/** 
 * A write attribute handler for the LDAP group member type attribute.
 *
 * @author Carl Harris
 */
public class GroupMemberTypeHandler
    extends AbstractWriteAttributeHandler<Void> {

  static final GroupMemberTypeHandler INSTANCE =
      new GroupMemberTypeHandler();
  
  private GroupMemberTypeHandler() {
    super(GroupSearchDefinition.GROUP_MEMBER_TYPE);
  }
