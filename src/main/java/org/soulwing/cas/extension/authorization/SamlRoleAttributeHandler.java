...
/** 
 * A write attribute handler for the SAML role attributes attribute.
 *
 * @author Carl Harris
 */
public class SamlRoleAttributeHandler
    extends AbstractWriteAttributeHandler<Void> {

  static final SamlRoleAttributeHandler INSTANCE =
      new SamlRoleAttributeHandler();
  
  private SamlRoleAttributeHandler() {
    super(SamlDefinition.ROLE_ATTRIBUTES);
  }
