...
/** 
 * A write attribute handler for the LDAP user member type attribute.
 *
 * @author Carl Harris
 */
public class UserMemberTypeHandler
    extends AbstractWriteAttributeHandler<Void> {

  static final UserMemberTypeHandler INSTANCE =
      new UserMemberTypeHandler();
  
  private UserMemberTypeHandler() {
    super(GroupSearchDefinition.USER_MEMBER_TYPE);
  }
