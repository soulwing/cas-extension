...
/** 
 * A write attribute handler for the LDAP role attributes attribute.
 *
 * @author Carl Harris
 */
public class LdapRoleAttributeHandler
    extends AbstractWriteAttributeHandler<Void> {

  static final LdapRoleAttributeHandler INSTANCE =
      new LdapRoleAttributeHandler();
  
  private LdapRoleAttributeHandler() {
    super(LdapSearchDefinition.ROLE_ATTRIBUTES);
  }
