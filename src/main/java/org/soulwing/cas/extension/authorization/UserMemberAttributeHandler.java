...
/** 
 * A write attribute handler for the LDAP user member attribute attribute.
 *
 * @author Carl Harris
 */
public class UserMemberAttributeHandler
    extends AbstractWriteAttributeHandler<Void> {

  static final UserMemberAttributeHandler INSTANCE =
      new UserMemberAttributeHandler();
  
  private UserMemberAttributeHandler() {
    super(GroupSearchDefinition.USER_MEMBER_ATTRIBUTE);
  }
