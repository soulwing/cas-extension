...
/**
 * A remove step handler for the authorization resource.
 *
 * @author Carl Harris
 */
public class AuthorizationRemove extends AbstractRemoveStepHandler {

  public static final AuthorizationRemove INSTANCE = 
      new AuthorizationRemove();
    
  private AuthorizationRemove() {    
  }
  ...
  protected void performRuntime(OperationContext context,
    ...
    SubsystemExtension.logger.info("removed authorization service " 
        + serviceName);
