...
/** 
 * A write attribute handler for the LDAP base attribute.
 *
 * @author Carl Harris
 */
public class LdapBaseHandler
    extends AbstractWriteAttributeHandler<Void> {

  static final LdapBaseHandler INSTANCE =
      new LdapBaseHandler();
  
  private LdapBaseHandler() {
    super(LdapSearchDefinition.BASE);
  }
