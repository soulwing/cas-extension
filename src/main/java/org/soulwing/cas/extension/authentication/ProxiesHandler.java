 ...
 * @author Carl Harris
 */
class ProxiesHandler extends AbstractWriteAttributeHandler<Void> {

  static final ProxiesHandler INSTANCE =
      new ProxiesHandler();
  
  private ProxiesHandler() {
    super(ProxyChainDefinition.PROXIES);
  }
